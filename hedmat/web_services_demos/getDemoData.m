...
%% Return the demo data in a struct for running the services.
    ...
    data.remodelRemoveColumnsText = fileread(...
        [dataPath 'other_data/remove_extra_rmdl.json']);
    data.remodelSummarizeColumnsText = fileread( ...
        [dataPath 'other_data/summarize_columns_rmdl.json']);
    data.remodelSummarizeTypesText = fileread(...
        [dataPath 'other_data/summarize_hed_types_rmdl.json']);
    data.remodelFactorTypesText = fileread(...
        [dataPath 'other_data/factor_hed_types_rmdl.json']);
    data.jsonBadText = ...
